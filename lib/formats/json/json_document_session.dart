...
import 'package:sreerajp_textapp/formats/json/json_stats.dart';
import 'package:sreerajp_textapp/formats/json/json_table.dart';
import 'package:sreerajp_textapp/formats/json/json_well_formed_gate.dart';
...
class JsonDocumentSession extends ChangeNotifier with ExternalChangeMixin {
  ...
  void setAutoSaveInterval(Duration interval) {
    ...
    _autoSaver?.stop();
    _autoSaver = null;
    if (_status == JsonLoadStatus.ready) _startAutoSave();
    _safeNotify();
  }
