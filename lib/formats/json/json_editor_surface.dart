...
import 'package:sreerajp_textapp/formats/json/json_find_panel.dart';
...
class JsonEditorSurface extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<JsonEditorSurface> createState() => _JsonEditorSurfaceState();
}

class _JsonEditorSurfaceState extends ConsumerState<JsonEditorSurface>
