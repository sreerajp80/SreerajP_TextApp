...
class _SaveOptionsBodyState extends State<_SaveOptionsBody> {
  ...
  late JsonIndent _indent = widget.session.indent;
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            DropdownButtonFormField<JsonIndent>(
              ...
              items: [
                for (final i in JsonIndent.values)
            ...
            CheckboxListTile(
              ...
              title: Text(l10n.jsonReformatStrict),
            ),
