...
/// UI actions for the shared output services on an XML document: share, share as
/// zip, print, and export/convert (task 9.6). Mirrors `JsonOutputActions`; the
/// services are shared and host-tested, so these helpers only gather the current
/// content and route it to the right service, reporting the outcome.
class XmlOutputActions {
  static const formatId = 'xml';
  ...
  Uint8List _bytes(XmlDocumentSession session) => codec.encode(
