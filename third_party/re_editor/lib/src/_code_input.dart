    ...
    if (!_hasInputConnection) {
      ...
      final TextInputConnection connection = TextInput.attach(this,
        _TextInputConfiguration(
          ...
          autocorrect: false,
          // PATCH: keep the Android keyboard from putting a composing region
          // over existing text, which duplicated the line on the first Enter
          // (flutter/flutter#31512). See PATCH_NOTES.md.
...
class _TextInputConfiguration extends TextInputConfiguration {
  ...
  const _TextInputConfiguration({
    ...
    super.enableSuggestions = false, // PATCH: see PATCH_NOTES.md
